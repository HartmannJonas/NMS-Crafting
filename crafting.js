...
function showItem(name, back) {
    ...
    $('#mainCard').fadeOut(400, function () {
        ...
        var path = "NMS-Crafting/resources/Images/" + name.replace(/\s/g, '') + ".png";
    ...
    $('#craftingCard').fadeOut(400, function () {
        ...
        if (ingLen > 0) {
            ...
            for (i = 0; i < ingLen; i++) {
                ...
                var path = "NMS-Crafting/resources/Images/" + ing.name.replace(/\s/g, '') + ".png";
    ...
    $('#shoppingListCard').fadeOut(400, function () {
        ...
        getShoppingList(name, 1, sList, function () {
            ...
            for (i = 0; i < sList.length; i++) {
                ...
                var path = "NMS-Crafting/resources/Images/" + sList[i].name.replace(/\s/g, '') + ".png";
    ...
    $('#craftingToCard').fadeOut(400, function () {
        ...
        craftToList = getCraftToList(name, craftToList, function () {
            craftToList.forEach(function (itemToCraftTo) {
                ...
                var path = "NMS-Crafting/resources/Images/" + itemToCraftTo.replace(/\s/g, '') + ".png";
